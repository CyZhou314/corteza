...
RUN go build -ldflags "-X github.com/cortezaproject/corteza/server/pkg/version.Version=${BUILD_VERSION} " -o build/corteza-server-latest-${GOOS}-${GOARCH} cmd/corteza/main.go
