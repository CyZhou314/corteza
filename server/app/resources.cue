...
resources: { [key=_]: {"handle": key, "component": "system", "platform": "corteza" } & schema.#PkgResource } & {
	"rbac-rule": {
		package: {
			ident: "rbac"
			import: "github.com/cyzhou314/corteza/server/pkg/rbac"
		}
	...
	"label": {
		package: {
			ident: "labels"
			import: "github.com/cyzhou314/corteza/server/pkg/label/types"
		}
	...
	"flag": {
		package: {
			ident: "flag"
			import: "github.com/cyzhou314/corteza/server/pkg/flag/types"
		}
	...
	"actionlog": {
		package: {
			ident: "actionlog"
			import: "github.com/cyzhou314/corteza/server/pkg/actionlog"
		}
	...
	"resource-activity": {
		package: {
			ident: "discovery"
			import: "github.com/cyzhou314/corteza/server/pkg/discovery/types"
		}
