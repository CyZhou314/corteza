...
// UserErrInvalidInitialsLength returns "system:user.invalidInitialsLength" as *errors.Error
//
// This function is auto-generated.
func UserErrInvalidInitialsLength(mm ...*userActionProps) *errors.Error {
	var p = &userActionProps{}
	if len(mm) > 0 {
		p = mm[0]
	}
	...
	var e = errors.New(
		...
		p.Format("initials length should not exceed 3 characters", nil),
		...
		// translation namespace & key
		errors.Meta(locale.ErrorMetaNamespace{}, "system"),
		errors.Meta(locale.ErrorMetaKey{}, "user.errors.invalidInitialsLength"),
...
// UserErrInvalidInitialsCharacter returns "system:user.invalidInitialsCharacter" as *errors.Error
//
// This function is auto-generated.
func UserErrInvalidInitialsCharacter(mm ...*userActionProps) *errors.Error {
	var p = &userActionProps{}
	if len(mm) > 0 {
		p = mm[0]
	}
	...
	var e = errors.New(
		...
		// translation namespace & key
		errors.Meta(locale.ErrorMetaNamespace{}, "system"),
		errors.Meta(locale.ErrorMetaKey{}, "user.errors.invalidInitialsCharacter"),
