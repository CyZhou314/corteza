...
func procEvents(mm ...string) (dd []*eventsDef, err error) {
	...
	const (
		importTypePathTpl = "github.com/cyzhou314/corteza/server/%s/types"
		importAutoPathTpl = "github.com/cyzhou314/corteza/server/%s/automation"
		importAuthPath    = "github.com/cyzhou314/corteza/server/pkg/auth"
	)
