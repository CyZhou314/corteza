module github.com/cyzhou314/corteza/extra/server-discovery

go 1.19

require (
	github.com/cyzhou314/corteza/server v0.0.0-00010101000000-000000000000
...
replace github.com/cyzhou314/corteza/server => ../../server
